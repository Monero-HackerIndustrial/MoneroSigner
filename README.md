...
# The sections below have not been updated yet.
The sections below are left over from the original seedsigner fork. I have
not updated most of the documentation yet. Once I have a stable release I can
update the documentation along with the build instructions and release keys.
